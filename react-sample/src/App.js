...
import UserViewComponent from "./user/user-view/view-user.component"
      ...
      <React.Fragment>  
        ...
        <Router>
          <Switch>
            ...
            <PrivateRoute path="/users-list" component={UserList} />
            <PrivateRoute path="/users-view" component={UserViewComponent} />
